...
- **SEO optimized with `next/metadata`**
- **Pagination, categories, and tags**
- **Subscription form with server actions**
- **Font Optimisation with next/font**
- **Fully responsive and mobile-friendly**
- **Beautiful animations and hover effects**
- **Ready-to-deploy on Vercel**
- **ShadCN UI components**
- **Used ReactMarkdown for rendering blogpost**
...
This template contains intentional dealays on fetch functions to demonstrate loading state, please remove them before deploying to the production
